...
- Always **pass the token down** to any async operations or methods that support it.
    
- Use `ThrowIfCancellationRequested` for **immediate termination**.
    
- Dispose of the `CancellationTokenSource` when done.
    
- Avoid forcibly aborting threads — cancellation is **cooperative**.
